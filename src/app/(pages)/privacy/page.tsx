        ...
        <div className="max-w-[900px] mx-auto px-6 lg:px-12">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <ul className="text-white/60 leading-relaxed mb-6 space-y-2 list-disc list-inside">
              ...
              <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy
              Policy) refers to DR. M SARFRAZ DENTAL CORPORATION, 101 - 6351 - 197 Street,
              ...
              <li><strong>Personal Data</strong> (or &quot;Personal Information&quot;) is any information that relates to an
              identified or identifiable individual.
              We use &quot;Personal Data&quot; and &quot;Personal Information&quot; interchangeably unless a law
              uses a specific term.</li>
            ...
            <h4 className="text-white text-lg font-semibold mb-2 mt-4">
              Personal Data
            </h4>
            <p className="text-white/60 leading-relaxed mb-4">
            ...
            <ul className="text-white/60 leading-relaxed mb-4 space-y-1 list-disc list-inside">
              <li>Email address</li>
            ...
            <ul className="text-white/60 leading-relaxed mb-4 space-y-2 list-disc list-inside">
            ...
            <ul className="text-white/60 leading-relaxed mb-4 space-y-1 list-disc list-inside">
              ...
              <li><strong>Purpose:</strong> These Cookies are used to track information about traffic to the Website
            ...
            <ul className="text-white/60 leading-relaxed mb-4 space-y-2 list-disc list-inside">
              ...
              <li><strong>To provide You with news, special offers, and general information</strong> about other
              ...
              <li><strong>For business transfers:</strong> We may use Your Personal Data to evaluate or conduct a
            ...
            <ul className="text-white/60 leading-relaxed mb-6 space-y-2 list-disc list-inside">
              <li><strong>With Service Providers:</strong> We may share Your Personal Data with Service Providers to
              ...
              <li><strong>With Affiliates:</strong> We may share Your Personal Data with Our affiliates, in which case we
              ...
              <li><strong>With business partners:</strong> We may share Your Personal Data with Our business partners
              to offer You certain products, services or promotions.</li>
              <li><strong>With other users:</strong> If Our Service offers public areas, when You share Personal Data or
            ...
            <ul className="text-white/60 leading-relaxed mb-4 space-y-1 list-disc list-inside">
              <li><strong>Legal obligation:</strong> We are required by law to retain specific data (e.g., financial records
              ...
              <li><strong>Technical limitations:</strong> Data exists in backup systems that are scheduled for routine
              deletion.</li>
            </ul>
            <p className="text-white/60 leading-relaxed mb-4">
            ...
            <ul className="text-white/60 leading-relaxed mb-6 space-y-1 list-disc list-inside">
              <li><strong>Deletion:</strong> Personal Data is removed from Our systems and no longer actively processed.</li>
              <li><strong>Backup retention:</strong> Residual copies may remain in encrypted backups for a limited
              period consistent with our backup retention schedule and are not restored except
              where necessary for security, disaster recovery, or legal compliance.</li>
              <li><strong>Anonymization:</strong> In some cases, We convert Personal Data into anonymous statistical
              data that cannot be linked back to You. This anonymized data may be retained
              indefinitely for research and analytics.</li>
            </ul>
            ...
            <h5 className="text-white text-base font-semibold mb-2 mt-3">
              Google Analytics
            </h5>
            <p className="text-white/60 leading-relaxed mb-4">
            ...
            <p className="text-white/60 leading-relaxed mb-6">
              ...
              Privacy &amp; Terms web page: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">https://policies.google.com/privacy</a>
            </p>
            ...
            <ul className="text-white/60 leading-relaxed mb-6 space-y-2 list-disc list-inside">
              ...
              <li>By mail: 101 - 6351 - 197 Street LANGLEY, B.C V2Y 1X8 CANADA</li>
            </ul>
          </div>
        </div>
      </section>
