  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1200px] 2xl:max-w-[1400px] mx-auto px-5 sm:px-6 2xl:px-12 py-16 sm:py-24 lg:py-32 text-center">
        ...
        {/* CTA Buttons */}
        <div className="mt-8 sm:mt-12 lg:mt-16 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto">
          <a
            href="/contact#contact-form"
            className="w-full sm:w-auto inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-4 bg-white text-[#1d1d1f] text-sm font-semibold rounded-full hover:bg-white/90 transition-colors duration-200"
          >
            Schedule Free Consultation
          </a>
          <a
            href="tel:+16045331151"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 text-white text-sm font-medium rounded-full border border-white/30 hover:bg-white/10 transition-colors duration-200"
